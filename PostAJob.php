...
<body>
    ...
    <div class="container job-posting">
        ...
        <form action="create_job.php" method="post">
            ...
            <input type="text" id="title" name="title" class="job-input" required>

            <label for="description">Job Description:</label>
            <textarea id="description" name="description" class="job-input" rows="4" required></textarea>

            <label for="salary">Salary:</label>
            <input type="text" id="salary" name="salary" class="job-input" required>

            <label for="location">Location:</label>
            <input type="text" id="location" name="location" class="job-input" placeholder="City,Country.." required>

            <label for="type">Job Type:</label>
            <select id="type" name="type" class="job-input" required>
